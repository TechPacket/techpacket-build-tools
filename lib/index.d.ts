...
interface TechpacketBuildToolsOptions {
  /**
  ...
  /**
   * Restart the process when specific files are modified.
   */
...
type Options = TechpacketBuildToolsOptions | ((opts: TechpacketBuildToolsOptions) => TechpacketBuildToolsOptions)
